## Edited for Synergie-Sindragosa realm. Only Naxxramas & OS at the moment.
...
1. Download the addon from the **main** repository (https://github.com/ForestJ316/DBM-Warmane-SindragosaEdit/archive/refs/heads/main.zip).
2. Inside the zip file, open DBM-Warmane-SindragosaEdit-main. Copy/Paste all those folders (DBM-Core, DBM-GUI, etc) into your addons folder (Interface/Addons). DO NOT put the DBM-Warmane-SindragosaEdit-main folder directly into the addon folder, it will not work.
...
1. Download the addon from the **main** repository (https://github.com/ForestJ316/DBM-Warmane-SindragosaEdit/archive/refs/heads/main.zip).
2. Inside the zip file, open DBM-Warmane-SindragosaEdit-main. Select all the folders (DBM-Core, DBM-GUI, etc) and press Copy (Ctrl+C).
...
4. On your addons folder (Interface/Addons), Paste (Ctrl+V) the previously copied folders here. DO NOT put the DBM-Warmane-SindragosaEdit-main folder directly into the addon folder, it will not work.
